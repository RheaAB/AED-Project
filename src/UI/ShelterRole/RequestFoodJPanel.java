...
public class RequestFoodJPanel extends javax.swing.JPanel {
    ...
    public RequestFoodJPanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise, ESystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        checkBakery.setBackground(new java.awt.Color(153, 153, 153));
        ...
        checkDairy.setBackground(new java.awt.Color(153, 153, 153));
        ...
        checkMeat.setBackground(new java.awt.Color(153, 153, 153));
        ...
        checkCereals.setBackground(new java.awt.Color(153, 153, 153));
        ...
        checkVegetables.setBackground(new java.awt.Color(153, 153, 153));
        ...
        checkFruits.setBackground(new java.awt.Color(153, 153, 153));
