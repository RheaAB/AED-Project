...
public class QualityCheckDashBoardJPanel extends javax.swing.JPanel {
    ...
    //Organization organization,Enterprise enterprise, ESystem business
    //JPanel userProcessContainer, UserAccount account, QualityOrganization qualityOrganization, Enterprise enterprise
    public QualityCheckDashBoardJPanel(JPanel userProcessContainer, UserAccount account, QualityOrganization qualityOrganization, Enterprise enterprise, ESystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        showProductBtn.setBackground(new java.awt.Color(0, 0, 0));
        ...
        showProductBtn.setBorderPainted(false);
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if (request.getReceiver().equals(userAccount) && (request.getStatus().equalsIgnoreCase("Pending") || request.getStatus().equalsIgnoreCase("Processing"))){
            ...
            ProcessWorkRequestDashBoardJPanel processWorkRequestJPanel = new ProcessWorkRequestDashBoardJPanel(userProcessContainer, request);
