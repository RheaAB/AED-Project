...
public class NGODashBoardJPanel extends javax.swing.JPanel {
    ...
    public NGODashBoardJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise, ESystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnSendtoDistributor.setBackground(new java.awt.Color(0, 0, 0));
        ...
        btnSendtoDistributor.setBorderPainted(false);
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if (request.getReceiver().equals(userAccount) && (request.getStatus().equalsIgnoreCase("Pending") || request.getStatus().equalsIgnoreCase("Processing"))) {
            ...
            ProcessWorkDashBoardJPanel processWorkRequestJPanel = new ProcessWorkDashBoardJPanel(userProcessContainer, request);
