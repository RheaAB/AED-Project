 ...
 * @author rheab
 */
public class ManageEnterpriseAdminDashBoardJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageEnterpriseAdminDashBoardJPanel
     */
    private JPanel userProcessContainer;
    private ESystem ecosystem;

    public ManageEnterpriseAdminDashBoardJPanel(JPanel userProcessContainer, ESystem ecosystem) {
        initComponents();
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (email.equalsIgnoreCase("") || pass.equalsIgnoreCase("") || ename.equalsIgnoreCase("")) {
            ...
            JOptionPane.showMessageDialog(null, "Enter a valid EmailID");
        } else {

            Employee employee = enterprise.getEmployeeDirectory().createEmployee(ename);

            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(email, pass, employee, new AdminRole());
