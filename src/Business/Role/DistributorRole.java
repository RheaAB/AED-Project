...
import UI.Distributors.DistributorAreaJPanel;
...
public class DistributorRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, ESystem business) {
        return new DistributorAreaJPanel(userProcessContainer, account, (DistributorOrganization)organization, enterprise, business);
    }
